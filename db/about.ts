...
export const mainSections: TextContainerProps[] = [
  {
    title: "GF Montiform",
    paragraphs: [
...
export const mateSections: TextContainerProps[] = [
  {
    title: "Matteo",
    subtitle:
  ...
  {
    title: "Vassillissa",
    subtitle: "Vassillissa - madrelingua russa",
    paragraphs: [
  ...
  {
    title: "Akiko",
    subtitle: "Akiko - madrelingua giapponese",
    paragraphs: [
